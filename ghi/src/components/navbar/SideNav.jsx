...
const SideNav = () => {
    ...
    const adminNavLinks = role === 'admin' ? [{ name: 'Admin', href: '/admin', current: location.pathname === '/admin' }, { name: '- View Applications', href: '/view-applications', current: location.pathname === '/view-applications' }, { name: '- View/Edit Employee Time Clock', href: '/timeclock-admin', current: location.pathname === '/timeclock-admin' }, { name: '- Assign User Roles', href: '/assign-role', current: location.pathname === '/assign-role' }, { name: '- View Showings/Bookings', href: '/view-bookings', current: location.pathname === '/view-bookings'}, { name: '- AI Application Evaluation', href: '/AI-App-Evaluation', current: location.pathname === '/AI-App-Evaluation'} ] : [];
